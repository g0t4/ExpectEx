namespace ExpectEx
{
	...
	public abstract class ExpressionVisitor
	{
		...
		public virtual void VisitBinaryNodeType(BinaryExpression b)
		{
		}
		...
		public virtual Expression VisitConditional(ConditionalExpression c)
		{
			...
			VisitConditionalAfterTest(c);
			Expression ifTrue = this.Visit(c.IfTrue);
			VisitConditionalAfterTrue(c);
		...
		public virtual void VisitConditionalAfterTrue(ConditionalExpression expression)
		{
			
		}

		public virtual void VisitConditionalAfterTest(ConditionalExpression expression)
		{
		...
		public virtual Expression VisitMethodCall(MethodCallExpression m)
		{
			...
			VisitMethodCallBeforeArguments(m);
		...
		public virtual void VisitMethodCallBeforeArguments(MethodCallExpression expression)
		{
		...
		public virtual ReadOnlyCollection<Expression> VisitExpressionList(ReadOnlyCollection<Expression> original)
		{
			...
			for (int i = 0, n = original.Count; i < n; i++)
			{
				...
				if(i < n - 1)
				{
					VisitBetweenExpressionListItems(original[i], original[i+1]);
				}
				if (list != null)
				{
					list.Add(p);
		...
		public virtual void VisitBetweenExpressionListItems(Expression current, Expression next)
		{
		}
		...
		public virtual NewExpression VisitNew(NewExpression newExpression)
		{
